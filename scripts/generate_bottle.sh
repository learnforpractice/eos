...
mkdir -p ${PROJECT}/${VERSION}/opt/uuosio/lib/cmake
...
echo "class Uuosio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/uuosio/uuos/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/uuosio/uuos/releases/download/v${VERSION}\"
