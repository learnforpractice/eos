...
static PyObject *
semlock_count(SemLockObject *self, void *Py_UNUSED(ignored))
{
    return PyLong_FromLong((long)self->count);
}

static PyObject *
semlock_ismine(SemLockObject *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
semlock_getvalue(SemLockObject *self, void *Py_UNUSED(ignored))
{
#ifdef HAVE_BROKEN_SEM_GETVALUE
...
static PyObject *
semlock_iszero(SemLockObject *self, void *Py_UNUSED(ignored))
{
#ifdef HAVE_BROKEN_SEM_GETVALUE
    if (sem_trywait(self->handle) < 0) {
        if (errno == EAGAIN)
...
static PyObject *
semlock_afterfork(SemLockObject *self, void *Py_UNUSED(ignored))
{
    self->count = 0;
    Py_RETURN_NONE;
}
