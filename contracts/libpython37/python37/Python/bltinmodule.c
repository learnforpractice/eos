...
builtin_print(PyObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    for (i = 0; i < nargs; i++) {
        if (i > 0) {
            ...
            if (sep == NULL) {
                ...
                const char *str = PyUnicode_AsUTF8(sep);
                prints(str);
            }
#endif
        }
    ...
    if (end == NULL) {
        ...
        const char *str = PyUnicode_AsUTF8(end);
        prints(str);
    }
...
#ifdef __WASM
//#include "../../eosiolib_wrapper/eosiolib.c"
typedef char bool;
...
#include "../../eosiolib_wrapper/action.c"
#include "../../eosiolib_wrapper/chain.c"
#include "../../eosiolib_wrapper/crypto.c"
#include "../../eosiolib_wrapper/transaction.c"
#include "../../eosiolib_wrapper/token.c"
#include "../../eosiolib_wrapper/permission.c"
#include "../../eosiolib_wrapper/privileged.c"
#include "../../eosiolib_wrapper/system.c"
#endif
