...
/* Forward */
static PyObject *dictkeys_new(PyObject *, PyObject *Py_UNUSED(ignored));
static PyObject *dictitems_new(PyObject *, PyObject *Py_UNUSED(ignored));
static PyObject *dictvalues_new(PyObject *, PyObject *Py_UNUSED(ignored));
