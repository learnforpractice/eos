...
static PyObject *
set_pop2(PySetObject *so, void *Py_UNUSED(ignored)) {
    return set_pop(so);
}
...
static PyObject *
set_copy2(PySetObject *so, void *Py_UNUSED(ignored))
{
    return make_new_set_basetype(Py_TYPE(so), (PyObject *)so);
}
...
static PyObject *
set_clear2(PySetObject *so, void *Py_UNUSED(ignored))
{
    set_clear_internal(so);
    Py_RETURN_NONE;
}
...
static PyMethodDef set_methods[] = {
    {"add",             (PyCFunction)set_add,           METH_O,
     add_doc},
    {"clear",           (PyCFunction)set_clear2,         METH_NOARGS,
     clear_doc},
    {"__contains__",(PyCFunction)set_direct_contains,           METH_O | METH_COEXIST,
     contains_doc},
    {"copy",            (PyCFunction)set_copy2,          METH_NOARGS,
     copy_doc},
    ...
    {"issuperset",      (PyCFunction)set_issuperset,    METH_O,
     issuperset_doc},
    {"pop",             (PyCFunction)set_pop2,           METH_NOARGS,
     pop_doc},
...
static PyObject *
test_c_api(PySetObject *so, void *Py_UNUSED(ignored))
{
    Py_ssize_t count;
    const char *s;
    Py_ssize_t i;
