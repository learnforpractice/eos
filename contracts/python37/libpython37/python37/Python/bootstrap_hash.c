...
static unsigned char *g_seed = {0x8a,0x6,0xa5,0x75,0x62,0x69,0x3a,0xfd,
                                0x7,0x5e,0xf,0x8c,0xa,0x25,0x6e,0xe8,
                                0x2e,0x56,0x9c,0xc9,0x44,0x0,0xfc,0x2b};
...
#ifdef __WASM
    memcpy(secret, g_seed, secret_size);
    return _Py_INIT_OK();
#endif
