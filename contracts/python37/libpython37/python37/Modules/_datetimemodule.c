...
static PyObject *
delta_total_seconds(PyObject *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
delta_reduce(PyDateTime_Delta* self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_isoformat(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_ctime(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_isoweekday(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_isocalendar(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_timetuple(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_toordinal(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
date_weekday(PyDateTime_Date *self, void *Py_UNUSED(ignored))
{
    int dow = weekday(GET_YEAR(self), GET_MONTH(self), GET_DAY(self));
...
static PyObject *
tzinfo_reduce(PyObject *self, void *Py_UNUSED(ignored))
{
    PyObject *args, *state;
...
static PyObject *
timezone_getinitargs(PyDateTime_TimeZone *self, void *Py_UNUSED(ignored))
{
    if (self->name == NULL)
...
static PyObject *
datetime_ctime(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
datetime_timetuple(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
    int dstflag = -1;
...
static PyObject *
datetime_timestamp(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
    PyObject *result;
...
static PyObject *
datetime_getdate(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
datetime_gettime(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
...
static PyObject *
datetime_gettimetz(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
    return new_time(DATE_GET_HOUR(self),
                    DATE_GET_MINUTE(self),
                    DATE_GET_SECOND(self),
...
static PyObject *
datetime_utctimetuple(PyDateTime_DateTime *self, void *Py_UNUSED(ignored))
{
    int y, m, d, hh, mm, ss;
    PyObject *tzinfo;
