...
static PyObject *py_send_deferred(PyObject *self, PyObject *args)
{
    ...
    _PyLong_AsByteArray((PyLongObject *)sender_id, (unsigned char *)&_sender_id, sizeof(uint128_t), 1, 0);
...
static PyObject *py_cancel_deferred(PyObject *self, PyObject *args)
{
    ...
    _PyLong_AsByteArray((PyLongObject *)o, (unsigned char *)&sender_id, sizeof(uint128_t), 1, 0);
