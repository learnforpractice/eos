...
const static name system_account_name    { N(uuos) };
const static name null_account_name      { N(uuos.null) };
const static name producers_account_name { N(uuos.prods) };
...
const static name eosio_auth_scope       { N(uuos.auth) };
const static name eosio_all_scope        { N(uuos.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name eosio_any_name  { N(uuos.any) };
const static name eosio_code_name { N(uuos.code) };
