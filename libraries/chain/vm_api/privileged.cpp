...
uint32_t vm_api_proxy::get_kv_parameters_packed( char *packed_kv_parameters, uint32_t size, uint32_t max_version ) {
...
void vm_api_proxy::set_kv_parameters_packed( const char *packed_kv_parameters, uint32_t size ) {
