...
extern "C" {
void Z_envZ_get_resource_limitsZ_vjiii( u64 account, u32 ram_bytes_offset, u32 net_weight_offset, u32 cpu_weight_offset ) {
...
void Z_envZ_set_resource_limitsZ_vjjjj( u64 account, u64 ram_bytes, u64 net_weight, u64 cpu_weight ) {
...
u64 Z_envZ_set_proposed_producersZ_jii( u32 producer_data_offset, u32 producer_data_size ) {
...
u32 Z_envZ_is_privilegedZ_ij( u64 account )  {
   return (u32)get_vm_api()->is_privileged( account );
}

/* import: 'env' 'set_privileged' */
void Z_envZ_set_privilegedZ_vji( u64 account, u32 is_priv ) {
   get_vm_api()->set_privileged( account, is_priv );
}

/* import: 'env' 'set_blockchain_parameters_packed' */
void Z_envZ_set_blockchain_parameters_packedZ_vii(u32 data_offset, u32 datalen) {
...
u32 Z_envZ_get_blockchain_parameters_packedZ_iii(u32 data_offset, u32 datalen) {
   char* data = (char *)offset_to_ptr(data_offset, datalen);
   return get_vm_api()->get_blockchain_parameters_packed(data, datalen);
}

/* import: 'env' 'activate_feature' */
void Z_envZ_activate_featureZ_vj( u64 f ) {
   get_vm_api()->activate_feature( (int64_t)f );
}

void Z_envZ_preactivate_featureZ_vi(u32 feature_offset) {
