...
void eosio_token_init() {
    ...
    init_eosio_token_6790d1941faa86d7405f41c7150ba746f99960bc6e37cce277d42d95f28b56bf();
    mem = get_memory_eosio_token_6790d1941faa86d7405f41c7150ba746f99960bc6e37cce277d42d95f28b56bf();
    mem->data_backup = (uint8_t*)calloc(mem->size, 1);
    mem->data_backup_size = mem->size;
    memcpy(mem->data_backup, mem->data, mem->size);
}

void wasm2c_eosio_token_apply(u64 receiver, u64 first_receiver, u64 action) {
    wasm_rt_memory_t *mem;
    static bool initialized = false;
    ...
    eosio_token_init_globals();
    mem = get_memory_eosio_token_6790d1941faa86d7405f41c7150ba746f99960bc6e37cce277d42d95f28b56bf();
//    memcpy(mem->data, mem->data_backup, mem->data_backup_size);
//    memset(mem->data + mem->data_backup_size, 0, mem->initial_pages * PAGE_SIZE-mem->data_backup_size);
    apply_eosio_token_6790d1941faa86d7405f41c7150ba746f99960bc6e37cce277d42d95f28b56bf(receiver, first_receiver, action);
}
