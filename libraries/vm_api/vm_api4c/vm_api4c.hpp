...
//privileged.h
        virtual void get_resource_limits( u64 account, u32 ram_bytes_offset, u32 net_weight_offset, u32 cpu_weight_offset );
        virtual void set_resource_limits( u64 account, u64 ram_bytes, u64 net_weight, u64 cpu_weight );
        virtual u64 set_proposed_producers( u32 producer_data_offset, u32 producer_data_size );
        virtual u32 is_privileged( u64 account );
        virtual void set_privileged( u64 account, u32 is_priv );
        virtual void set_blockchain_parameters_packed(u32 data_offset, u32 datalen);
        virtual u32 get_blockchain_parameters_packed(u32 data_offset, u32 datalen);
        virtual void activate_feature( u64 f );
