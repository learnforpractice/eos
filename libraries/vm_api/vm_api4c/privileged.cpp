...
void get_resource_limits( u64 account, u32 ram_bytes_offset, u32 net_weight_offset, u32 cpu_weight_offset ) {
...
void set_resource_limits( u64 account, u64 ram_bytes, u64 net_weight, u64 cpu_weight ) {
...
u64 set_proposed_producers( u32 producer_data_offset, u32 producer_data_size ) {
...
u32 get_blockchain_parameters_packed(u32 data_offset, u32 datalen) {
   char* data = (char *)offset_to_ptr(data_offset, datalen);
   return get_vm_api()->get_blockchain_parameters_packed(data, datalen);
}

/* import: 'env' 'activate_feature' */
void activate_feature( u64 f ) {
   get_vm_api()->activate_feature( (int64_t)f );
}

void preactivate_feature(u32 feature_offset) {
